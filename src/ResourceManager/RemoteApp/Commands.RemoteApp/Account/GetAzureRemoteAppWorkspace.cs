...
{
    [Cmdlet(VerbsCommon.Get, "AzureRmRemoteAppWorkspace")]
    public class GetAzureRemoteAppAccount : RemoteAppArmCmdletBase
    {
        public override void ExecuteCmdlet()
        {
            AccountDetailsWrapper account = RemoteAppClient.GetAccount();
