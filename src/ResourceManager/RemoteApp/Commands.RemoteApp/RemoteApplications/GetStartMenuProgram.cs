    ...
    public class GetStartMenuProgram : RemoteAppArmResourceCmdletBase
    {
        ...
        public class ApplicationComparer : IComparer<StartMenuApplication>
        {
            public int Compare(StartMenuApplication first, StartMenuApplication second)
            {
                ...
                return string.Compare(first.StartMenuApplicationName, second.StartMenuApplicationName, StringComparison.CurrentCultureIgnoreCase);
            }
        }
        ...
        private bool GetStartMenuApps(bool getAllPrograms)
        {
            ...
            if (response != null)
            {
                if (ExactMatch)
                {
                    ...
                    application = response.FirstOrDefault(app => String.Equals(app.StartMenuApplicationName, ProgramName, StringComparison.CurrentCultureIgnoreCase));
